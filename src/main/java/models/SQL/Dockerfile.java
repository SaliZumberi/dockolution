...
import tools.dockerlinter.DockerLinter;
import tools.githubminer.CommitProcessor;
...
public class Dockerfile {
    ...
    public long getOpneIssues() {
        return opneIssues;
    }

    public void setOpneIssues(long opneIssues) {
