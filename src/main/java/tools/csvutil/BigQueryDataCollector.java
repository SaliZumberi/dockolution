...
public class BigQueryDataCollector {
    ...
    public static void main(String[] args) throws Exception {
        CsvListReader reader = new CsvListReader(new FileReader(new File("bigquerydata\\data_9.csv")), CsvPreference.STANDARD_PREFERENCE);
        CsvListWriter writer = new CsvListWriter(new FileWriter(new File("bigquerydata\\data_99.csv"),true), CsvPreference.STANDARD_PREFERENCE);
